...
for i in INSTRUCTIONS:
    if i.mode.inh:
        print(i.mnemonic, "inh", i.mode.inh, i.mode.inh_sz)
    if i.mode.imm:
        print(i.mnemonic, "imm", i.mode.imm, i.mode.imm_sz)
    if i.mode.dir:
        print(i.mnemonic, "dir", i.mode.dir, i.mode.dir_sz)
    if i.mode.ind:
        print(i.mnemonic, "ind", i.mode.ind, i.mode.ind_sz)
    if i.mode.ext:
        print(i.mnemonic, "ext", i.mode.ext, i.mode.ext_sz)
    if i.mode.rel:
        print(i.mnemonic, "rel", i.mode.rel, i.mode.rel_sz)
